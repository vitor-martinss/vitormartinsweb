...
import project_img_cs_backoffice from '@/assets/img/portfolio-backoffice/backoffice.jpg';
import project_img_rovo from '@/assets/img/portfolio-rovo/rovo-multiple.jpg';

import project_img_ppcoa from '@/assets/img/portfolio-ppcoa/ppcoa-multiple.jpg';
...
const project_content: DataType = {
  ...
  blog_data_2: [
    {
      id: 2,
      img: project_img_cs_backoffice,
      bg_img: '/assets/img/portfolio-backoffice/backoffice.jpg',
                  ...
                  <Link href={item.path}>
                    <div className={`tp-portfolio-thumb img-${item.id} w-img fix`}>
                      ...
                      <div className="tp-portfolio-thumb-img">
                        <Image data-speed="0.85" style={{ height: '100%', objectFit: 'cover' }} src={item.img} alt="image-here" />
                      </div>
                    </div>
