...
import portfolio_img_2 from "@/assets/img/portfolio-backoffice/backoffice-main.jpg";
import portfolio_img_3 from "@/assets/img/portfolio-backoffice/backoffice.jpg";
                ...
                <div className="tp-portfolio-item-wrapper-3">
                  ...
                  {images.map((item, index) => (
                    <div key={index} className="tp-portfolio-item-3 portfolio-panel pb-80 tp-hover-reveal-text">
                      <a href="#">
                        <Image src={item} width={1425} height={812} style={{ height: '100%', objectFit: 'cover' }} alt="image-here" />
                        <span></span>
                      </a>
                    </div>
                  ))}
